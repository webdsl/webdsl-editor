...
public class StrategoWebDSLJavaXMLParseController extends DynamicParseController 
{ 
  private static final String LANGUAGE = "Stratego-WebDSL-Java-XML";
  ...
  { 
    try
    { 
      InputStream descriptorStream = StrategoWebDSLJavaXMLParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = StrategoWebDSLJavaXMLParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(StrategoWebDSLJavaXMLParseController.class);
    }
  ...
  { 
    return StrategoWebDSLJavaXMLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }

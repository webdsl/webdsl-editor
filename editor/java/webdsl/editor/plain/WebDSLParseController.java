...
public class WebDSLParseController extends DynamicParseController 
{ 
  private static final String LANGUAGE = "WebDSL";
  ...
  { 
    try
    { 
      InputStream descriptorStream = WebDSLParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = WebDSLParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(WebDSLParseController.class);
    }
